...
const TravelSection = ({
    ...
    travelCountryLoading, getTravelCountryData
}) => {
    return (
        <div className="space-y-6 animate-fade-in">
            <div>
                <h2 className="text-lg font-bold text-slate-900 tracking-tight">Travel Analytics</h2>
                <p className="text-sm text-slate-400 mt-0.5">Insights into trips and global activity.</p>
            </div>
