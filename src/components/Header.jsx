...
const Header = () => {
  ...
  const roleLabel = adminRole === 'super_admin' ? 'Super Admin' : adminRole === 'recruiter' ? 'Recruiter' : 'Admin';
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <div className="hidden md:block text-right mr-2 leading-none">
                ...
                <p className="text-[10px] text-slate-400 group-hover:text-slate-300">{roleLabel}</p>
              </div>
