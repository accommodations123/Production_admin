...
const MENU_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'People', path: '/dashboard/people', icon: Users, roles: ['super_admin', 'admin'] },
      { name: 'Stay Requests', path: '/dashboard/post-stay-requests', icon: Building, roles: ['super_admin', 'admin'] },
