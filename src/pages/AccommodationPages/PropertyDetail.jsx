                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    {p.listing_expires_at && (() => {
                                        ...
                                        if (isExpired) {
                                            return (
                                                <span className="px-3 py-1 bg-rose-500/20 text-rose-300 border border-rose-500/30 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-md">
                                                    Expired on {new Date(p.listing_expires_at).toLocaleDateString()}
                                                </span>
                                            );
                                        }
