                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6">
                            ...
                            <div className="bg-slate-800 rounded-2xl p-6 text-white">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="text-xs uppercase font-bold px-2.5 py-1 rounded-full bg-slate-700 text-slate-300 border border-slate-600">
                                        {selectedProperty.Host?.role || selectedProperty.owner?.role || 'Host'}
                                    </span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-slate-600 to-slate-700 flex items-center justify-center text-2xl font-bold shadow-lg flex-shrink-0">
