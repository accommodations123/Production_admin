...
const api = axios.create({
    // baseURL: "https://api.nextkinlife.live",
    ...
    const handleCreateJob = async () => {
        try {
            ...
            const payload = {
                ...
                responsibilities: filterEmpty(
                    formData.responsibilities
                ),

                preferred_skills: filterEmpty(
                    formData.preferred_skills
                ),

                benefits: filterEmpty(
                    formData.benefits
                ),

                skills: {
                    primary: filterEmpty(
                        formData.skills.primary
                    ),
                    secondary: filterEmpty(
                        formData.skills.secondary
                    ),
                    nice_to_have: filterEmpty(
                ...
                mandatory_conditions: filterEmpty(
                    ...
                    <div className="bg-white rounded-xl w-full max-w-3xl p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto mx-4">
                            ...
                            {activeTab === "basic" && (
                                <>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            placeholder="USC,H1B,OPT,CPT"
                                            value={formData.visa_status.join(",")}
                                            onChange={(e) =>
                                                setFormData({
                                                    ...formData,
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            className="text-blue-600 text-sm hover:text-blue-800 flex items-center gap-1"
                                        >
                                            <PlusIcon className="h-4 w-4" /> Add Benefit
                                        </button>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        />
                                        <input
                                            placeholder="Recruiter LinkedIn"
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        {formData.preferred_skills.map((skill, idx) => (
                                            <div key={idx} className="flex gap-2 mb-2">
                                                <input
                                                    value={skill}
                                                    onChange={(e) => {
                                                        const updated = [...formData.preferred_skills];
                                                        updated[idx] = e.target.value;
                                                        setFormData({
                                                            ...formData,
                                                    ...
                                                    placeholder={`Preferred skill ${idx + 1}`}
                                                    className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                />
                                        ...
                                        <button
                                            ...
                                            className="text-blue-600 text-sm hover:text-blue-800 flex items-center gap-1"
                                        >
                                            <PlusIcon className="h-4 w-4" /> Add Preferred Skill
                                        </button>
                                    </div>
                                </>
                            )}
                        ...
                        <div className="flex gap-3 pt-4 border-t">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="flex-1 bg-blue-400 text-white rounded-lg py-2 hover:bg-blue-500 transition disabled:opacity-50"
                            >
