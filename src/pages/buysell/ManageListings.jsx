                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{utcToLocal(listing.createdAt)}</p>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <Calendar className="w-4 h-4 mr-2 text-gray-400" />
                            <div>
                                ...
                                <p className="font-medium">{utcToLocal(listing.updatedAt)}</p>
                            </div>
                        </div>
                        <div className="flex items-center">
                ...
                <div className="bg-blue-50 p-5 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                <p className="text-xs text-gray-500">Email (Gmail)</p>
                                <p className="font-medium">{listing.sellerEmail || listing.email || listing.User?.email || "—"}</p>
                            </div>
                        </div>
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{listing.sellerPhone || listing.phone || "—"}</p>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <span className="w-4 h-4 mr-2 text-green-500 font-bold">💬</span>
                            <div>
                                <p className="text-xs text-gray-500">WhatsApp</p>
                                <p className="font-medium">
                                    {listing.sellerWhatsapp ? (
                                        <a href={`https://wa.me/${listing.sellerWhatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                                            {listing.sellerWhatsapp}
                                        </a>
                                    ) : "—"}
                                </p>
                        ...
                        <div className="flex items-center">
                            <span className="w-4 h-4 mr-2 text-pink-500 font-semibold">📸</span>
                            <div>
                                <p className="text-xs text-gray-500">Instagram</p>
                                <p className="font-medium">
                                    {listing.sellerInstagram ? (
                                        <a href={`https://instagram.com/${listing.sellerInstagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:underline">
                                            {listing.sellerInstagram}
                                        </a>
                                    ) : "—"}
                                </p>
                        ...
                        <div className="flex items-center">
                            <span className="w-4 h-4 mr-2 text-blue-600 font-semibold">👤</span>
                            <div>
                                <p className="text-xs text-gray-500">Facebook</p>
                                <p className="font-medium">
                                    {listing.sellerFacebook ? (
                                        <a href={listing.sellerFacebook.startsWith('http') ? listing.sellerFacebook : `https://facebook.com/${listing.sellerFacebook}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                                            {listing.sellerFacebook}
                                        </a>
                                    ) : "—"}
                                </p>
                            ...
                            <tbody className="divide-y divide-gray-200">
                                {data.map((l) => (
                                    <tr key={l.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="p-4 text-gray-700">{l.sellerEmail || l.email || l.User?.email || "—"}</td>
                                        <td className="p-4">
