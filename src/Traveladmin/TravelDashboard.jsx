...
const TravelDashboard = ({ trips = [] }) => {
  ...
  const stats = [
    ...
    { title: "Approved Trips", value: approvedTrips, icon: CheckCircle, color: "text-emerald-600", bg: "bg-emerald-50" },
    ...
    <div className="p-6 lg:p-8 animate-fade-in">
      <div className="max-w-7xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Overview of trips</p>
        </div>
